...
% ------------
% - implement the collective pitch feedforward controller in Simulink
% - calculate the ultimate loads
% - find useful values for T_Buffer_v to find best buffer time for ultimate
%   load reduction
% ------------
% History:
% v03:  David Schlipf on 28-Jul-2021: remove CalculateEOG
% v02:	David Schlipf on 17-Jan-2021
...
Parameter                       = NREL5MWDefaultParameter_FF_Ex11(Parameter);
...
T_Buffer_v  = [4.5:0.1:5];     %[4.5:0.1:5]                                                     % needs adjustment !!!
...
for i_T_Buffer=1:n_T_Buffer
    ...
    P_el_FF(:,i_T_Buffer)           = logsout.get('y').Values.P_el.Data;
